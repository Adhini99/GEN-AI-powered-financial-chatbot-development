# -*- coding: utf-8 -*-
"""AI_driven_Financial_ChatBot_Prototype Python application.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1xm5gEbf77fVFCO1EFjDnyW7MdisqBvpW
"""
...
final_report = pd.read_csv('/content/drive/MyDrive/BCG-GENAI/final_data_report.csv')
summary_report = pd.read_csv('/content/drive/MyDrive/BCG-GENAI/Summary_final_report.csv')
...
def financial_chatbot():
    ...
    # Check user query within the function
    if user_query == "What is the total revenue?":
        revenue = final_report[(final_report['Year'] == fiscal_year) & (final_report['Company'] == company_input)]['Total Revenue'].values[0]
        print(f"The Total Revenue for {company_input} for fiscal year {fiscal_year} is $ {revenue}")
        ...
        print(f"The Net Income for {company_input} for fiscal year {fiscal_year} is $ {net_income}")
        ...
        print(f"The sum of Total Assets for {company_input} for fiscal year {fiscal_year} is $ {total_assets}")
        ...
        print(f"The sum of Total Liabilities for {company_input} for fiscal year {fiscal_year} is $ {total_liabilities}")
        ...
        print(f"The Cash Flow from Operating Activities for {company_input} for fiscal year {fiscal_year} is $ {cash_ops}")
        ...
        print(f"The Revenue Growth(%) for {company_input} for fiscal year {fiscal_year} is {revenue_growth}(%)")
        ...
        print(f"The Net Income Growth(%) for {company_input} for fiscal year {fiscal_year} is {net_income_growth}(%)")
        ...
        print(f"The Assets Growth(%) for {company_input} for fiscal year {fiscal_year} is {assets_growth}(%)")
        ...
        print(f"The Liabilities Growth(%) for {company_input} for fiscal year {fiscal_year} is {liabilities_growth}(%)")
        ...
        print(f"The Cash Flow from Operations Growth(%) for {company_input} for fiscal year {fiscal_year} is {cash_ops_growth}(%)")
        ...
        print(f"The Year By Year Average Revenue Growth Rate(%) from 2021 to 2023 for {company_input} is {year_avg_revenue_growth}(%)")
        ...
        print(f"The Year By Year Net Income Revenue Growth Rate(%) from 2021 to 2023 for {company_input} is {year_avg_net_income_growth}(%)")
        ...
        print(f"The Year By Year Average Assets Growth Rate(%) from 2021 to 2023 for {company_input} is {year_avg_assets_growth}(%)")
        ...
        print(f"The Year By Year Average Liabilities Growth Rate(%) from 2021 to 2023 for {company_input} is {year_avg_liabilities_growth}(%)")
        ...
        print(f"The Year By Year Average Cash Flow from Operations Growth Rate(%) from 2021 to 2023 for {company_input} is {year_avg_cash_ops_growth}(%)")

    else:
        print("Sorry, I cannot only provide information on the requested query.")
